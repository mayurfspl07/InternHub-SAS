...
TAG_METADATA = [
    ...
    {"name": "Blogs", "description": "Public marketing blog posts — published posts are publicly readable; admins create, update, publish, and delete."},
    {"name": "Leads", "description": "Public lead capture from marketing-site forms (honeypot + rate limited) and read-only Platform Super Admin inbox."},
    {"name": "Dashboard", "description": "Aggregated analytics, quick statistics, and recent activity."},
    {"name": "Admin Dashboard", "description": "Single-response unified administrative dashboard with full organization analytics, presence list, open tasks, active projects, and pending leave."},
    {"name": "Mentor Dashboard", "description": "Single-response unified mentor dashboard with assigned mentees, project status, mentee open tasks, and pending leave."},
    {"name": "Intern Dashboard", "description": "Single-response unified intern dashboard with today's check-in/out status, streak, assigned projects, assigned tasks, and personal logs."},
    {"name": "Superadmin Dashboard", "description": "Single-response unified platform superadmin dashboard with multi-tenant stats, organization directories, and system health."},
    ...
    custom_responses: Dict[str, Dict[str, Any]] = {
                ...
                "present_today_list": [
                    {
                        ...
                        "check_out": None,
                        "hours_worked": 4.5,
                        "check_in_photo_url": "/api/attendance/1/photo/checkin",
                    }
                ],
                "open_tasks": [task_sample],
                "active_projects": [project_sample],
                "pending_leave_requests": [leave_sample],
                "attendance_chart": [{"date": "2026-08-21", "hours": 120.0, "present": 18, "status": "present"}],
                "recent_activity": [audit_sample],
                "streak": 0,
            },
            "description": "Dynamic single-response dashboard auto-tailored by caller role (Admin, Mentor, Intern, SuperAdmin)",
        },
        ("GET", "/api/admin/dashboard"): {
            "example": {
                "role": "admin",
                "organization": {"id": 1, "name": "Acme Tech", "slug": "acme", "type": "business"},
                "stats": {
                    "present_today": 18,
                    "absent_today": 5,
                    "on_leave_today": 1,
                ...
                "pending_leave_requests": [leave_sample],
                "attendance_chart": [{"date": "2026-08-21", "hours": 120.0, "present": 18, "status": "present"}],
                "project_status": {"active": 5, "completed": 3},
                "task_status": {"todo": 6, "in_progress": 10, "done": 25},
                "recent_activity": [audit_sample],
                "streak": 0,
            },
            "description": "Full single-response Admin Dashboard (KPIs, presence list with selfie photos, open/overdue tasks, active projects, and pending leave requests)",
        },
        ("GET", "/admin/dashboard"): {
            "example": {
                "role": "admin",
                "organization": {"id": 1, "name": "Acme Tech", "slug": "acme", "type": "business"},
                "stats": {"present_today": 18, "absent_today": 5, "open_tasks": 16, "active_projects": 5},
                "present_today_list": [{"user_id": 1, "name": "Jane Doe", "status": "present", "check_in": "09:30"}],
                "open_tasks": [task_sample],
                "active_projects": [project_sample],
                "pending_leave_requests": [leave_sample],
            },
            "description": "Full single-response Admin Dashboard (Root route alias)",
        },
        ("GET", "/api/mentor/dashboard"): {
            "example": {
                ...
                "present_today_list": [{"user_id": 1, "name": "Jane Doe", "today_status": "present", "check_in": "09:30"}],
                "projects": [project_sample],
                "open_tasks": [task_sample],
                "pending_leave_requests": [leave_sample],
                "attendance_chart": [{"date": "2026-08-21", "hours": 42.0, "present": 6, "status": "present"}],
                "task_status": {"todo": 3, "in_progress": 4, "done": 12},
                "recent_activity": [audit_sample],
                "streak": 0,
            },
            "description": "Full single-response Mentor Dashboard (Assigned mentees, streak, today check-in photos, mentee projects, open tasks, and pending leave)",
        },
        ("GET", "/mentor/dashboard"): {
            "example": {
                "role": "mentor",
                "stats": {"assigned_interns_count": 8, "present_today": 6, "open_tasks": 7},
                "assigned_interns": [{"user_id": 1, "name": "Jane Doe", "today_status": "present", "streak": 5}],
                "projects": [project_sample],
                "open_tasks": [task_sample],
            },
            "description": "Full single-response Mentor Dashboard (Root route alias)",
        },
        ("GET", "/api/intern/dashboard"): {
            "example": {
                ...
                "assigned_projects": [project_sample],
                "assigned_tasks": [task_sample],
                "open_tasks": [task_sample],
                "attendance_chart": [{"date": "2026-08-21", "hours": 7.5, "status": "present"}],
                "recent_leave_requests": [leave_sample],
                "announcements": [announcement_sample],
                "recent_activity": [audit_sample],
            },
            "description": "Full single-response Intern Dashboard (Today check-in/out status, streak, assigned projects, assigned tasks, and personal logs)",
        },
        ("GET", "/intern/dashboard"): {
            "example": {
                "role": "intern",
                "today_attendance": {"has_checked_in": True, "check_in": "09:30", "status": "present"},
                "streak": 5,
                "assigned_projects": [project_sample],
                "assigned_tasks": [task_sample],
            },
            "description": "Full single-response Intern Dashboard (Root route alias)",
        },
        ("GET", "/api/superadmin/dashboard"): {
            "example": {
                ...
                "stats": {
                    ...
                    "total_business_orgs": 8,
                    "total_educational_orgs": 4,
                    "total_users": 150,
                    "total_admins": 15,
                    "total_mentors": 35,
                    "total_interns": 100,
            ...
            "description": "Full single-response SuperAdmin Dashboard (Multi-tenant metrics, organizations directory, platform audit log, and system health)",
        },
        ("GET", "/superadmin/dashboard"): {
            "example": {
                "role": "superadmin",
                "stats": {"total_organizations": 12, "total_users": 150, "total_projects": 45},
                "organizations": [{"id": 1, "name": "Acme Tech", "user_count": 45, "project_count": 10}],
                "system_health": {"status": "operational", "database": "connected"},
            },
            "description": "Full single-response SuperAdmin Dashboard (Root route alias)",
        },
        ("GET", "/api/dashboard/present-today"): {
            "example": {
                "interns": [
                    {
                        "id": 1,
            ...
            "description": "List of interns marked present/late/half-day today",
        },
        ("GET", "/api/dashboard/open-tasks"): {
            "example": {"tasks": [task_sample]},
            "description": "List of open (not done) tasks scoped to caller",
        },
        ("GET", "/api/dashboard/attendance-chart"): {
            "example": {
                "month": "2026-08",
                "chart": [{"date": "2026-08-21", "hours": 8.0, "present": 1, "status": "present"}],
                "total_interns": 1,
            },
            "description": "Attendance history chart bounded to calendar month (default: current month)",
        },
