...
| 52 | `GET` | `/api/dashboard` | `dashboard.py` | Dashboard analytics | Required | All authenticated (scoped) | None | `stats`, `attendance_chart`, `project_status`, `task_status`, `streak` | Multiple Models |
